import { Project, UserProfile } from '@/types/journey';
import {
    FolderOpen,
    Plus,
    ChevronLeft,
                    ...
                    >
                        ...
                        {!isCollapsed && (
                            <div className="flex-1 min-w-0 text-left">
                                ...
                                <p className="text-[10px] text-muted-foreground truncate uppercase tracking-tighter font-bold">{user.plan} Plan</p>
                            </div>
                        )}
                    </button>
